    ...
    if not recs_df.empty:
        ...
        if not visible_recs.empty:
            ...
            for match_name in unique_matches:
                ...
                # Lowkey title prefixing without being extravagant
                title_prefix = "⚽"
                if is_match_ended:
                ...
                with st.expander(f"{title_prefix} {match_name}", expanded=False):
                    ...
                    for i, row in enumerate(match_data.itertuples()):
                        ...
                        # Subdued and direct banner content
                        status_banner_html = ""
                        if row_status == "ended":
                        ...
                        # Utilizing st.html explicitly handles all indentation without throwing raw text formatting bugs
                        st.html(f"""
